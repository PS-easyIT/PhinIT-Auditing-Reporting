...
VERWENDUNG:
    Als Script:     .\easyADReport_v0.5.5.ps1
    Als EXE:        .\easyADReport_v0.5.5.exe
...
COPYRIGHT:
    2025 PhinIT. Alle Rechte vorbehalten.

VERSION HISTORY:
    0.5.5 - Aktuelle Version
            - Optimiert für EXE-Konvertierung
