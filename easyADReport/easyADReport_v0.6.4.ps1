<#
================================================================================
    easyADReport - Active Directory Reporting Tool
    Version: 0.5.5
...
VORAUSSETZUNGEN:
    ...
    - Administrator-Rechte für vollständigen AD-Zugriff
    - Domänen-Mitgliedschaft oder Zugriff auf Domain Controller

FEATURES:
    - Moderne WPF-Benutzeroberfläche mit Tabs
    - 20+ vordefinierte AD-Reports
    - Benutzer-, Gruppen- und Computer-Analysen
    - OU-Struktur und GPO-Übersichten
    - Privilegierte Gruppen-Monitoring
    - Export nach CSV und HTML
    - Echtzeit-Statusanzeige
    - Fehlerprotokollierung

VERWENDUNG:
    Als Script:     .\easyADReport_v0.6.4.ps1
    Als EXE:        .\easyADReport_v0.6.4.exe
    
    Hinweis: Bei EXE-Ausführung erscheint UAC-Dialog für Admin-Rechte.
...
<Window
    ...
    Title="easyADReport v0.6.X Series"
    Width="1850"
    Height="1000"
    Background="#F8FAFC"
    FontFamily="Segoe UI"
                    ...
                    <StackPanel>
                        ...
                        <Expander
                            ...
                            <StackPanel>
                                ...
                                <Button
                                    x:Name="ButtonQuickOrgChart"
                                    Content="Organization Chart"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Export organizational hierarchy and structure" />
                            </StackPanel>
                        </Expander>
                        ...
                        <Expander
                            ...
                            <StackPanel>
                                ...
                                <Button
                                    x:Name="ButtonQuickLoginTimeAnalysis"
                                    Content="Login Time Analysis"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Analyze unusual login times and patterns" />
                                <Button
                                    x:Name="ButtonQuickAccountCreationTimeline"
                                    Content="Account Creation Timeline"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Timeline of account creations with creator info" />
                                <Button
                                    x:Name="ButtonQuickDeletedObjectsRecovery"
                                    Content="Deleted Objects Recovery"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Recently deleted AD objects and recovery options" />
                                <Button
                                    x:Name="ButtonQuickProxyAddressChanges"
                                    Content="ProxyAddress Changes"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Track changes to ProxyMailAddress attributes" />
                                <Button
                                    x:Name="ButtonQuickNestedGroupDepth"
                                    Content="Nested Group Depth"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Analyze group nesting depth and complexity" />
                                <Button
                                    x:Name="ButtonQuickGroupMembershipTimeline"
                                    Content="Group Membership Timeline"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Track group membership changes over time" />
                                <Button
                                    x:Name="ButtonQuickUPNConflicts"
                                    Content="UPN Conflicts"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Detect duplicate or invalid UPNs" />
                                <Button
                                    x:Name="ButtonQuickManagerChainValidation"
                                    Content="Manager Chain Validation"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Validate manager hierarchies and detect circular references" />
                                <Button
                                    x:Name="ButtonQuickMultipleEmailAddresses"
                                    Content="Multiple Email Addresses"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Users with multiple email addresses and aliases" />
                            </StackPanel>
                        </Expander>
                        ...
                        <Expander
                            ...
                            <StackPanel>
                                ...
                                <Button
                                    x:Name="ButtonQuickKerberosDelegation"
                                    Content="Kerberos Delegation"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Analyze Kerberos delegation configurations" />
                                <Button
                                    x:Name="ButtonQuickCertificateServices"
                                    Content="Certificate Services"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Analyze certificate services security" />
                                <Button
                                    x:Name="ButtonQuickLAPSAnalysis"
                                    Content="LAPS Analysis"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Check LAPS deployment status" />
                                <Button
                                    x:Name="ButtonQuickProtectedUsers"
                                    Content="Protected Users Group"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Analyze Protected Users group membership" />
                                <Button
                                    x:Name="ButtonQuickAuthPolicies"
                                    Content="Authentication Policies"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Review authentication policies and silos" />
                                <Button
                                    x:Name="ButtonQuickNTLMAudit"
                                    Content="NTLM Audit"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Audit NTLM usage and identify legacy systems" />
                                <Button
                                    x:Name="ButtonQuickPreWin2000Access"
                                    Content="Pre-Win2000 Access"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Check Pre-Windows 2000 Compatible Access group" />
                                <Button
                                    x:Name="ButtonQuickPAWAnalysis"
                                    Content="PAW Analysis"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Analyze Privileged Access Workstations" />
                                <Button
                                    x:Name="ButtonQuickPasswordSpray"
                                    Content="Password Spray Detection"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Detect password spray attack indicators" />
                                <Button
                                    x:Name="ButtonQuickPasswordComplexity"
                                    Content="Password Complexity"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Check password complexity compliance" />
                                <Button
                                    x:Name="ButtonQuickSmartCardRequired"
                                    Content="Smart Card Required"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Accounts requiring smart card authentication" />
                                <Button
                                    x:Name="ButtonQuickKerberosEncryption"
                                    Content="Kerberos Encryption Types"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Analyze Kerberos encryption types (DES/RC4/AES)" />
                            </StackPanel>
                        </Expander>
                        ...
                        <Expander
                            ...
                            <StackPanel>
                                ...
                                <Button
                                    x:Name="ButtonQuickComputerTrustErrors"
                                    Content="Computer Trust Errors"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Find computers with broken domain trust" />
                                <Button
                                    x:Name="ButtonQuickIPv6Readiness"
                                    Content="IPv6 Readiness"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Check IPv6 readiness and dual-stack configuration" />
                            </StackPanel>
                        </Expander>
                        ...
                        <Expander
                            ...
                            <StackPanel>
                                ...
                                <Button
                                    x:Name="ButtonQuickGoldenTicket"
                                    Content="Golden Ticket Indicators"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Detect Golden Ticket attack indicators" />
                                <Button
                                    x:Name="ButtonQuickSilverTicket"
                                    Content="Silver Ticket Indicators"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Detect Silver Ticket attack indicators" />
                                <Button
                                    x:Name="ButtonQuickPassTheHash"
                                    Content="Pass-the-Hash Indicators"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Detect Pass-the-Hash attack patterns" />
                                <Button
                                    x:Name="ButtonQuickSkeletonKey"
                                    Content="Skeleton Key Detection"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Detect Skeleton Key malware indicators" />
                            </StackPanel>
                        </Expander>
                        ...
                        <Expander
                            Header="📜 Compliance and Audit"
                            IsExpanded="False"
                            Style="{StaticResource ExpanderStyle}">
                            <StackPanel>
                                <Button
                                    x:Name="ButtonQuickDSGVOCompliance"
                                    Content="DSGVO/GDPR Compliance"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="DSGVO compliance report with sensitive data access" />
                                <Button
                                    x:Name="ButtonQuickAuditPolicyCompliance"
                                    Content="Audit Policy Compliance"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Check audit policy configuration and compliance" />
                                <Button
                                    x:Name="ButtonQuickObjectAccessAuditing"
                                    Content="Object Access Auditing"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Analyze object access patterns and anomalies" />
                                <Button
                                    x:Name="ButtonQuickPrivilegedOperationTracking"
                                    Content="Privileged Operation Tracking"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Track privileged operations and schema changes" />
                                <Button
                                    x:Name="ButtonQuickAccountLockoutTracking"
                                    Content="Account Lockout Tracking"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Track account lockout sources and patterns" />
                                <Button
                                    x:Name="ButtonQuickLoginTrends"
                                    Content="Login Trends"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Analyze login trends and patterns over time" />
                                <Button
                                    x:Name="ButtonQuickAccountCreationTrends"
                                    Content="Account Creation Trends"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Track account creation patterns and bulk events" />
                                <Button
                                    x:Name="ButtonQuickGroupMembershipChanges"
                                    Content="Group Membership Changes"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Track group membership changes over time" />
                                <Button
                                    x:Name="ButtonQuickPasswordChangeFrequency"
                                    Content="Password Change Frequency"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Analyze password change patterns and compliance" />
                                <Button
                                    x:Name="ButtonQuickPCIDSSCompliance"
                                    Content="PCI-DSS Compliance"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Check PCI-DSS compliance requirements" />
                            </StackPanel>
                        </Expander>
                        ...
                        <Expander
                            ...
                            <StackPanel>
                                ...
                                <Button
                                    x:Name="ButtonQuickGPOConflictAnalysis"
                                    Content="GPO Conflict Analysis"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Detect conflicting GPO settings and priorities" />
                                <Button
                                    x:Name="ButtonQuickGPOSecurityBaseline"
                                    Content="GPO Security Baseline"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Compare GPOs against security best practices" />
                                <Button
                                    x:Name="ButtonQuickGPOBackupStatus"
                                    Content="GPO Backup Status"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Check GPO backup status and age" />
                                <Button
                                    x:Name="ButtonQuickGPOVersionDiscrepancy"
                                    Content="GPO Version Discrepancy"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Detect GPO version mismatches between AD and SYSVOL" />
                                <Button
                                    x:Name="ButtonQuickWMIFilterAnalysis"
                                    Content="WMI Filter Analysis"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Analyze WMI filters and their usage" />
                                <Button
                                    x:Name="ButtonQuickGPOLoopback"
                                    Content="GPO Loopback Processing"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Identify GPOs with loopback processing" />
                            </StackPanel>
                        </Expander>
                        ...
                        <Expander
                            ...
                            <StackPanel>
                                ...
                                <Button
                                    x:Name="ButtonQuickStaleDNSRecords"
                                    Content="Stale DNS Records"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Find stale DNS records without computer objects" />
                                <Button
                                    x:Name="ButtonQuickDynamicDNSRegistration"
                                    Content="Dynamic DNS Registration"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Check dynamic DNS registration status" />
                                <Button
                                    x:Name="ButtonQuickSubnetAssignment"
                                    Content="Subnet Assignment"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Analyze subnet assignments and site links" />
                                <Button
                                    x:Name="ButtonQuickReplicationLatency"
                                    Content="Replication Latency"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Check replication latency between DCs" />
                                <Button
                                    x:Name="ButtonQuickSiteLinkCosts"
                                    Content="Site Link Costs"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Analyze site link costs and optimization" />
                                <Button
                                    x:Name="ButtonQuickExchangeAttributes"
                                    Content="Exchange Attributes"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Analyze Exchange attributes and orphaned objects" />
                                <Button
                                    x:Name="ButtonQuickAzureADConnect"
                                    Content="Azure AD Connect Status"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Check Azure AD Connect sync status" />
                                <Button
                                    x:Name="ButtonQuickCustomAttributes"
                                    Content="Custom Attribute Usage"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Analyze custom attribute usage and consistency" />
                                <Button
                                    x:Name="ButtonQuickAdminCountAnomalies"
                                    Content="AdminCount Anomalies"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Detect AdminCount inconsistencies" />
                                <Button
                                    x:Name="ButtonQuickComputerLifecycle"
                                    Content="Computer Lifecycle"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Analyze computer age and replacement recommendations" />
                                <Button
                                    x:Name="ButtonQuickNamingConventionViolations"
                                    Content="Naming Convention Violations"
                                    Style="{StaticResource SidebarButton}"
                                    ToolTip="Find naming convention violations" />
                            </StackPanel>
                        </Expander>
        ...
        <Border
            ...
            <Grid Margin="20,0">
                ...
                <TextBlock
                    ...
                    FontSize="11"
                    Foreground="#E5E7EB"
                    Text="easyADReport  |  Version: v0.6.2  |  Last Update: 30.12.2025" />
...
# ===== INITIALISIERUNG =====
# Progress Bars deaktivieren für saubere GUI-Darstellung
...
Function Write-ADReportLog {
    ...
    # StandardmÃ¤ÃŸig nur GUI, Terminal deaktiviert für EXE-Konvertierung
    if (-not $GUI -and -not $Terminal) {
        $GUI = $true
        $Terminal = $false  # Deaktiviert für EXE-Version
    }
    ...
    # Ausgabe im Terminal (deaktiviert für EXE-Kompilierung)
    # if ($Terminal) {
    #     switch ($Type) {
...
Function Get-ADGroupReportData {
    ...
    try {
        ...
        # Debug-Info ins Logfile schreiben
        Write-DebugLog "FÃ¼hre Get-ADGroup mit Filter '$FilterToUse' und Eigenschaften '$($PropertiesToLoad -join ', ')' aus" -Category "ADQuery"
...
Function Get-ADComputerReportData {
    ...
    try {
        ...
        # Debug-Info ins Logfile schreiben
        Write-DebugLog "FÃ¼hre Get-ADComputer mit Filter '$FilterToUse' und Eigenschaften '$($PropertiesToLoad -join ', ')' aus" -Category "ADQuery"
...
Function Get-DSGVOComplianceReport {
    [CmdletBinding()]
    param()
    
    try {
        Write-ADReportLog -Message "Erstelle DSGVO/GDPR Compliance Report..." -Type Info
        
        $ComplianceResults = @()
        
        # Lade alle Benutzer mit relevanten DSGVO-Attributen
        $Properties = @(
            'DisplayName', 'SamAccountName', 'EmailAddress', 'Department', 'Title',
            'PasswordLastSet', 'LastLogonDate', 'whenCreated', 'Enabled',
            'MemberOf', 'Description', 'Manager', 'telephoneNumber', 'mobile',
            'physicalDeliveryOfficeName', 'streetAddress', 'city', 'postalCode', 'country'
        )
        
        $AllUsers = Get-ADUser -Filter * -Properties $Properties -ErrorAction Stop
        Write-ADReportLog -Message "Analysiere $($AllUsers.Count) Benutzer für DSGVO-Compliance..." -Type Info
        
        foreach ($user in $AllUsers) {
            # Berechne Passwort-Alter
            $passwordAge = if ($user.PasswordLastSet) {
                (New-TimeSpan -Start $user.PasswordLastSet -End (Get-Date)).Days
            } else {
                999
            ...
            # Prüfe auf sensible Gruppenmitgliedschaften
            $sensitiveGroups = @()
            if ($user.MemberOf) {
                foreach ($groupDN in $user.MemberOf) {
                    $groupName = ($groupDN -split ',')[0] -replace 'CN=', ''
                    if ($groupName -match 'admin|privileged|sensitive|finance|hr|payroll') {
                        $sensitiveGroups += $groupName
                    }
                }
            }
            
            # Prüfe personenbezogene Daten
            $hasPersonalData = $false
            $personalDataFields = @()
            if ($user.telephoneNumber) { $hasPersonalData = $true; $personalDataFields += "Telefon" }
            if ($user.mobile) { $hasPersonalData = $true; $personalDataFields += "Mobil" }
            if ($user.streetAddress) { $hasPersonalData = $true; $personalDataFields += "Adresse" }
            if ($user.EmailAddress) { $hasPersonalData = $true; $personalDataFields += "Email" }
            
            # Compliance-Status ermitteln
            $complianceIssues = @()
            $complianceScore = 100
            
            # Inaktive Accounts mit personenbezogenen Daten
            if ($daysSinceLastLogon -gt 180 -and $hasPersonalData) {
                $complianceIssues += "Inaktiver Account (>180 Tage) mit personenbezogenen Daten"
                $complianceScore -= 30
            }
            
            # Sehr alte Passwörter
            if ($passwordAge -gt 365) {
                $complianceIssues += "Passwort älter als 1 Jahr"
                $complianceScore -= 20
            }
            
            # Deaktivierte Accounts mit Daten
            if (-not $user.Enabled -and $hasPersonalData) {
                $complianceIssues += "Deaktivierter Account mit personenbezogenen Daten (Löschung prüfen)"
                $complianceScore -= 25
            }
            
            # Fehlende Daten bei aktiven Accounts
            if ($user.Enabled -and -not $user.Manager) {
                $complianceIssues += "Kein Manager zugewiesen (Verantwortlichkeit unklar)"
                $complianceScore -= 10
            }
            
            # Sensible Gruppen ohne aktuelle Aktivität
            if ($sensitiveGroups.Count -gt 0 -and $daysSinceLastLogon -gt 90) {
                $complianceIssues += "Sensible Gruppenmitgliedschaft ohne aktuelle Aktivität"
                $complianceScore -= 25
            }
            ...
            $ComplianceResults += [PSCustomObject]@{
                ...
                DisplayName = $user.DisplayName
                Department = if ($user.Department) { $user.Department } else { "Nicht angegeben" }
                Enabled = $user.Enabled
                PersonalDataFields = if ($personalDataFields.Count -gt 0) { $personalDataFields -join ", " } else { "Keine" }
                LastPasswordChange = if ($user.PasswordLastSet) { $user.PasswordLastSet.ToString("dd.MM.yyyy") } else { "Nie" }
                PasswordAgeDays = $passwordAge
                LastLogon = if ($user.LastLogonDate) { $user.LastLogonDate.ToString("dd.MM.yyyy") } else { "Nie" }
                DaysSinceLastLogon = $daysSinceLastLogon
                AccountCreated = if ($user.whenCreated) { $user.whenCreated.ToString("dd.MM.yyyy") } else { "Unbekannt" }
                AccountAgeDays = $accountAge
                SensitiveGroups = if ($sensitiveGroups.Count -gt 0) { $sensitiveGroups -join ", " } else { "Keine" }
                ComplianceScore = $complianceScore
                ComplianceStatus = if ($complianceScore -ge 80) { "Gut" } elseif ($complianceScore -ge 60) { "Akzeptabel" } else { "Kritisch" }
                Issues = if ($complianceIssues.Count -gt 0) { $complianceIssues -join " | " } else { "Keine" }
                Recommendation = if ($complianceScore -lt 60) { "Dringend prüfen und bereinigen" } elseif ($complianceScore -lt 80) { "Regelmäßige Überprüfung empfohlen" } else { "Keine Maßnahmen erforderlich" }
            }
        }
        
        Write-ADReportLog -Message "DSGVO Compliance Report erstellt. $($ComplianceResults.Count) Benutzer analysiert." -Type Info
        return $ComplianceResults | Sort-Object ComplianceScore
        
    } catch {
        Write-ADReportLog -Message "Fehler beim DSGVO Compliance Report: $($_.Exception.Message)" -Type Error
        return @()
    }
}

Function Get-LoginTimeAnalysis {
    [CmdletBinding()]
    param()
    
    try {
        Write-ADReportLog -Message "Analysiere Login-Zeiten und Muster..." -Type Info
        
        $LoginAnalysis = @()
        $Properties = @('DisplayName', 'SamAccountName', 'Department', 'LastLogonDate', 'LastLogonTimestamp', 'logonCount', 'Enabled')
        $AllUsers = Get-ADUser -Filter {Enabled -eq $true} -Properties $Properties -ErrorAction Stop
        
        Write-ADReportLog -Message "Analysiere Login-Zeiten für $($AllUsers.Count) aktive Benutzer..." -Type Info
        
        foreach ($user in $AllUsers) {
            if (-not $user.LastLogonDate) { continue }
            
            $lastLogon = $user.LastLogonDate
            $dayOfWeek = $lastLogon.DayOfWeek
            $hourOfDay = $lastLogon.Hour
            
            $isWeekend = ($dayOfWeek -eq 'Saturday' -or $dayOfWeek -eq 'Sunday')
            $isNightTime = ($hourOfDay -lt 6 -or $hourOfDay -ge 22)
            $isOutsideBusinessHours = ($hourOfDay -lt 7 -or $hourOfDay -ge 19)
            ...
            if ($isWeekend) {
                $riskScore += 20
                $patterns += "Wochenend-Login"
                $flags += "Weekend"
            }
            
            if ($isNightTime) {
                $riskScore += 30
                $patterns += "Nacht-Login (22:00-06:00)"
                $flags += "Night"
            }
            
            if ($isOutsideBusinessHours -and -not $isNightTime) {
                $riskScore += 10
                $patterns += "Außerhalb Geschäftszeiten"
                $flags += "AfterHours"
            }
            
            if ($user.logonCount -lt 5) {
                $riskScore += 15
                $patterns += "Sehr wenige Logins"
                $flags += "RareLogin"
            }
            
            if ($riskScore -gt 0) {
                $LoginAnalysis += [PSCustomObject]@{
                    UserName = $user.SamAccountName
                    DisplayName = $user.DisplayName
                    Department = if ($user.Department) { $user.Department } else { "Nicht angegeben" }
                    LastLoginDate = $lastLogon.ToString("dd.MM.yyyy")
                    LastLoginTime = $lastLogon.ToString("HH:mm:ss")
                    ...
                    RiskScore = $riskScore
                    RiskLevel = if ($riskScore -ge 50) { "Hoch" } elseif ($riskScore -ge 30) { "Mittel" } else { "Niedrig" }
                    Patterns = if ($patterns.Count -gt 0) { $patterns -join " | " } else { "Normal" }
                    Flags = if ($flags.Count -gt 0) { $flags -join ", " } else { "None" }
                    Recommendation = if ($riskScore -ge 50) { "Dringend prüfen - ungewöhnliches Login-Verhalten" } elseif ($riskScore -ge 30) { "Überprüfung empfohlen" } else { "Beobachten" }
                }
            }
        }
        
        if ($LoginAnalysis.Count -eq 0) {
            $LoginAnalysis += [PSCustomObject]@{
                UserName = "Keine Auffälligkeiten"
                DisplayName = "N/A"
                Department = "N/A"
                LastLoginDate = "N/A"
                LastLoginTime = "N/A"
                ...
                RiskScore = 0
                RiskLevel = "Keine"
                Patterns = "Alle Logins innerhalb normaler Geschäftszeiten"
                Flags = "None"
                Recommendation = "Keine Maßnahmen erforderlich"
            }
        }
        
        Write-ADReportLog -Message "Login-Zeit Analyse abgeschlossen. $($LoginAnalysis.Count) auffällige Muster gefunden." -Type Info
        return $LoginAnalysis | Sort-Object RiskScore -Descending
        
    } catch {
        Write-ADReportLog -Message "Fehler bei der Login-Zeit Analyse: $($_.Exception.Message)" -Type Error
        return @()
    }
}

Function Get-OrganizationChart {
    [CmdletBinding()]
    param()
    
    try {
        Write-ADReportLog -Message "Erstelle Organigramm-Export..." -Type Info
        
        $OrgChart = @()
        $Properties = @('DisplayName', 'SamAccountName', 'Department', 'Title', 'Manager', 'Enabled', 'EmailAddress', 'telephoneNumber', 'physicalDeliveryOfficeName', 'company', 'DistinguishedName')
        $AllUsers = Get-ADUser -Filter * -Properties $Properties -ErrorAction Stop
        
        Write-ADReportLog -Message "Verarbeite $($AllUsers.Count) Benutzer für Organigramm..." -Type Info
        
        # PERFORMANCE-OPTIMIERUNG: Alle Manager-Beziehungen vorher laden
        Write-ADReportLog -Message "Lade Manager-Beziehungen..." -Type Info
        $AllManagers = @{}
        foreach ($u in $AllUsers) {
            if ($u.Manager) {
                if (-not $AllManagers.ContainsKey($u.Manager)) {
                    $AllManagers[$u.Manager] = @()
                }
                $AllManagers[$u.Manager] += $u
            }
        }
        
        # Manager-Objekte in Hash-Table für schnellen Zugriff
        $ManagerCache = @{}
        foreach ($u in $AllUsers) {
            if ($u.Manager) {
                $ManagerCache[$u.Manager] = $u
            }
        }
        
        foreach ($user in $AllUsers) {
            $managerName = "Kein Manager"
            $managerSAM = "N/A"
            $hierarchyLevel = 0
            
            if ($user.Manager) {
                if ($ManagerCache.ContainsKey($user.Manager)) {
                    $managerObj = $ManagerCache[$user.Manager]
                    $managerName = $managerObj.DisplayName
                    $managerSAM = $managerObj.SamAccountName
                } else {
                    try {
                        $managerObj = Get-ADUser -Identity $user.Manager -Properties DisplayName, SamAccountName -ErrorAction SilentlyContinue
                        if ($managerObj) {
                            $managerName = $managerObj.DisplayName
                            $managerSAM = $managerObj.SamAccountName
                        }
                    } catch {
                        $managerName = "Manager nicht gefunden"
                    }
                }
            }
            
            # PERFORMANCE-OPTIMIERUNG: DirectReports aus vorgeladener Hash-Table
            $directReports = if ($AllManagers.ContainsKey($user.DistinguishedName)) {
                $AllManagers[$user.DistinguishedName].Count
            } else { 0 }
            
            $currentManager = $user.Manager
            while ($currentManager -and $hierarchyLevel -lt 10) {
                $hierarchyLevel++
                try {
                    $managerObj = Get-ADUser -Identity $currentManager -Properties Manager -ErrorAction SilentlyContinue
            ...
            $OrgChart += [PSCustomObject]@{
                EmployeeName = $user.DisplayName
                SamAccountName = $user.SamAccountName
                Department = if ($user.Department) { $user.Department } else { "Nicht zugewiesen" }
                Title = if ($user.Title) { $user.Title } else { "Nicht angegeben" }
                Manager = $managerName
                ManagerSAM = $managerSAM
                DirectReports = $directReports
                HierarchyLevel = $hierarchyLevel
                Company = if ($user.company) { $user.company } else { "Nicht angegeben" }
                Location = if ($user.physicalDeliveryOfficeName) { $user.physicalDeliveryOfficeName } else { "Nicht angegeben" }
                Email = if ($user.EmailAddress) { $user.EmailAddress } else { "Keine" }
                Phone = if ($user.telephoneNumber) { $user.telephoneNumber } else { "Keine" }
                Enabled = $user.Enabled
                IsManager = if ($directReports -gt 0) { "Ja ($directReports Mitarbeiter)" } else { "Nein" }
                Recommendation = if (-not $user.Manager -and $user.Enabled) { "Manager zuweisen" } elseif ($directReports -gt 15) { "Große Teamgröße - Struktur prüfen" } else { "OK" }
            }
        }
        
        Write-ADReportLog -Message "Organigramm-Export erstellt. $($OrgChart.Count) Mitarbeiter verarbeitet." -Type Info
        
        # Debug-Ausgabe
        if ($OrgChart.Count -eq 0) {
            Write-ADReportLog -Message "WARNUNG: Keine Benutzer für Organigramm gefunden!" -Type Warning
            return @([PSCustomObject]@{
                EmployeeName = "Keine Daten"
                SamAccountName = "N/A"
                Department = "Keine Benutzer gefunden"
                Title = "N/A"
                Manager = "N/A"
                ManagerSAM = "N/A"
                DirectReports = 0
                ...
                Enabled = "N/A"
                IsManager = "N/A"
                Recommendation = "Prüfen Sie die AD-Verbindung und Berechtigungen"
            })
        }
        
        return $OrgChart | Sort-Object HierarchyLevel, Department, EmployeeName
        
    } catch {
        Write-ADReportLog -Message "Fehler beim Organigramm-Export: $($_.Exception.Message)" -Type Error
        return @()
    }
}

Function Get-GPOConflictAnalysis {
    [CmdletBinding()]
    param()
    
    try {
        Write-ADReportLog -Message "Analysiere GPO-Konflikte..." -Type Info
        
        if (-not (Get-Module -ListAvailable -Name GroupPolicy)) {
            Write-ADReportLog -Message "GroupPolicy Modul nicht verfügbar. Installiere RSAT-Tools." -Type Warning
            return @([PSCustomObject]@{
                GPOName1 = "Modul nicht verfügbar"
                GPOName2 = "N/A"
                ConflictType = "Fehler"
                Setting = "GroupPolicy PowerShell Modul nicht installiert"
                Value1 = "N/A"
                Value2 = "N/A"
                Priority = "N/A"
                AffectedOUs = "N/A"
                Resolution = "Installiere RSAT-Tools: Install-WindowsFeature RSAT-AD-PowerShell"
                Recommendation = "RSAT-Tools für GPO-Analyse erforderlich"
            })
        }
        ...
        Write-ADReportLog -Message "Analysiere $($AllGPOs.Count) GPOs auf Konflikte..." -Type Info
        ...
        foreach ($gpo in $AllGPOs) {
            try {
                ...
                if ($gpoReport) {
                    ...
                    if ($links) {
                        foreach ($link in $links) {
                            $ouPath = $link.SOMPath
                            if (-not $GPOLinks.ContainsKey($ouPath)) {
                                $GPOLinks[$ouPath] = @()
                            }
                            $GPOLinks[$ouPath] += @{
                                GPO = $gpo
                ...
                Write-ADReportLog -Message "Warnung: GPO $($gpo.DisplayName) konnte nicht analysiert werden" -Type Warning
            }
        }
        
        foreach ($ou in $GPOLinks.Keys) {
            $linkedGPOs = $GPOLinks[$ou] | Sort-Object Order
            
            if ($linkedGPOs.Count -gt 1) {
                for ($i = 0; $i -lt $linkedGPOs.Count - 1; $i++) {
                    $gpo1 = $linkedGPOs[$i].GPO
                    $gpo2 = $linkedGPOs[$i + 1].GPO
                    
                    $conflictType = "Potentieller Konflikt"
                    if ($gpo1.GpoStatus -eq "AllSettingsDisabled" -or $gpo2.GpoStatus -eq "AllSettingsDisabled") {
                        $conflictType = "Deaktivierte GPO"
                    }
                    
                    $Conflicts += [PSCustomObject]@{
                        GPOName1 = $gpo1.DisplayName
                        GPOName2 = $gpo2.DisplayName
                        ConflictType = $conflictType
                        Setting = "Mehrere GPOs auf gleicher OU"
                        Value1 = "Priorität: $($linkedGPOs[$i].Order)"
                        Value2 = "Priorität: $($linkedGPOs[$i + 1].Order)"
                        Priority = "GPO1 hat Vorrang (niedrigere Link-Order)"
                        AffectedOUs = $ou
                        Resolution = if ($linkedGPOs[$i].Order -lt $linkedGPOs[$i + 1].Order) { "$($gpo1.DisplayName) überschreibt $($gpo2.DisplayName)" } else { "$($gpo2.DisplayName) überschreibt $($gpo1.DisplayName)" }
                        Recommendation = "Einstellungen in beiden GPOs prüfen und konsolidieren"
                    }
                }
            }
        }
        ...
        if ($Conflicts.Count -eq 0) {
            $Conflicts += [PSCustomObject]@{
                GPOName1 = "Keine Konflikte"
                GPOName2 = "N/A"
                ConflictType = "Keine"
                Setting = "Alle GPOs sind eindeutig zugeordnet"
                Value1 = "N/A"
                Value2 = "N/A"
                Priority = "N/A"
                AffectedOUs = "N/A"
                Resolution = "Keine Konflikte gefunden"
                Recommendation = "GPO-Struktur ist sauber"
            }
        }
        
        Write-ADReportLog -Message "GPO-Konflikt Analyse abgeschlossen. $($Conflicts.Count) potentielle Konflikte gefunden." -Type Info
        return $Conflicts
        
    } catch {
        Write-ADReportLog -Message "Fehler bei der GPO-Konflikt Analyse: $($_.Exception.Message)" -Type Error
        return @()
    }
}

Function Get-GPOSecurityBaseline {
    [CmdletBinding()]
    param()
    
    try {
        Write-ADReportLog -Message "Vergleiche GPOs mit Security Baseline..." -Type Info
        
        if (-not (Get-Module -ListAvailable -Name GroupPolicy)) {
            Write-ADReportLog -Message "GroupPolicy Modul nicht verfügbar." -Type Warning
            return @([PSCustomObject]@{
                GPOName = "Modul nicht verfügbar"
                Category = "Fehler"
                Setting = "GroupPolicy PowerShell Modul nicht installiert"
                CurrentValue = "N/A"
                ...
                Severity = "High"
                Baseline = "N/A"
                Impact = "Keine Analyse möglich"
                Recommendation = "Installiere RSAT-Tools"
            })
        }
        ...
        Write-ADReportLog -Message "Analysiere $($AllGPOs.Count) GPOs gegen Security Baseline..." -Type Info
        ...
        try {
            ...
            $checks = @(
                @{
                    ...
                    Current = $DomainPolicy.MinPasswordLength
                    Recommended = $SecurityBaseline.MinimumPasswordLength
                    Category = "Password Policy"
                },
                @{
                    Setting = "Maximum Password Age"
                    Current = $DomainPolicy.MaxPasswordAge.Days
                    Recommended = $SecurityBaseline.MaxPasswordAge
                    Category = "Password Policy"
                },
                @{
                    Setting = "Minimum Password Age"
                    Current = $DomainPolicy.MinPasswordAge.Days
                    Recommended = $SecurityBaseline.MinPasswordAge
                    Category = "Password Policy"
                },
                @{
                    Setting = "Lockout Threshold"
                    Current = $DomainPolicy.LockoutThreshold
                    Recommended = $SecurityBaseline.AccountLockoutThreshold
            ...
            foreach ($check in $checks) {
                ...
                if ($check.Setting -like "*Minimum*Length*") {
                    $compliant = $check.Current -ge $check.Recommended
                    $severity = if (-not $compliant) { "High" } else { "Low" }
                } elseif ($check.Setting -like "*Maximum*Age*") {
                    $compliant = $check.Current -le $check.Recommended
                    $severity = if (-not $compliant) { "Medium" } else { "Low" }
                } elseif ($check.Setting -like "*Lockout*") {
                    $compliant = $check.Current -le $check.Recommended -and $check.Current -gt 0
                    $severity = if (-not $compliant) { "Medium" } else { "Low" }
                } else {
                    $compliant = $check.Current -ge $check.Recommended
                }
                ...
                $BaselineChecks += [PSCustomObject]@{
                    ...
                    ComplianceStatus = if ($compliant) { "Compliant" } else { "Non-Compliant" }
                    Severity = $severity
                    Baseline = "CIS Benchmark / Microsoft Security Baseline"
                    Impact = if (-not $compliant) { "Sicherheitsrisiko" } else { "Keine" }
                    Recommendation = if (-not $compliant) { "Wert auf $($check.Recommended) anpassen" } else { "Keine Änderung erforderlich" }
                }
            }
        } catch {
            Write-ADReportLog -Message "Warnung: Domain Password Policy konnte nicht gelesen werden" -Type Warning
        }
        
        if ($BaselineChecks.Count -eq 0) {
            $BaselineChecks += [PSCustomObject]@{
                GPOName = "Keine Daten"
                Category = "N/A"
                Setting = "Keine Baseline-Checks verfügbar"
                CurrentValue = "N/A"
                RecommendedValue = "N/A"
        ...
        Write-ADReportLog -Message "GPO Security Baseline Vergleich abgeschlossen. $($BaselineChecks.Count) Checks durchgeführt." -Type Info
        return $BaselineChecks | Sort-Object Severity -Descending
        
    } catch {
        Write-ADReportLog -Message "Fehler beim GPO Security Baseline Vergleich: $($_.Exception.Message)" -Type Error
        return @()
    }
}

Function Get-AccountCreationTimeline {
    [CmdletBinding()]
    param()
    
    try {
        Write-ADReportLog -Message "Erstelle Account-Erstellungs-Timeline..." -Type Info
        
        $Timeline = @()
        $Properties = @('DisplayName', 'SamAccountName', 'whenCreated', 'ObjectClass', 'Department', 'Enabled', 'Description')
        
        # Filter-Datum berechnen (PowerShell AD-Filter unterstützen keine Inline-Berechnungen)
        $CutoffDate = (Get-Date).AddDays(-90)
        
        $RecentUsers = Get-ADUser -Filter * -Properties $Properties -ErrorAction SilentlyContinue | Where-Object { $_.whenCreated -gt $CutoffDate }
        $RecentComputers = Get-ADComputer -Filter * -Properties $Properties -ErrorAction SilentlyContinue | Where-Object { $_.whenCreated -gt $CutoffDate }
        $RecentGroups = Get-ADGroup -Filter * -Properties $Properties -ErrorAction SilentlyContinue | Where-Object { $_.whenCreated -gt $CutoffDate }
        
        $AllObjects = @()
        $AllObjects += $RecentUsers
        $AllObjects += $RecentComputers
        $AllObjects += $RecentGroups
        
        Write-ADReportLog -Message "Analysiere $($AllObjects.Count) kürzlich erstellte Objekte..." -Type Info
        
        $GroupedByDate = $AllObjects | Group-Object { $_.whenCreated.Date }
        
        foreach ($obj in $AllObjects) {
            $createdDate = $obj.whenCreated
            $objectType = if ($obj.ObjectClass -eq 'user') { "Benutzer" } elseif ($obj.ObjectClass -eq 'computer') { "Computer" } else { "Gruppe" }
            
            $sameDay = @($GroupedByDate | Where-Object { $_.Name -eq $createdDate.Date }).Group
            $bulkCreation = $sameDay.Count -gt 5
            
            $pattern = "Normal"
            $suspicious = "Keine"
            
            if ($bulkCreation) {
                $pattern = "Massen-Erstellung ($($sameDay.Count) Objekte am gleichen Tag)"
                if ($sameDay.Count -gt 20) {
                    $suspicious = "Sehr viele Objekte - Automatisierung oder Migration?"
                }
            }
            
            if ($objectType -eq "Benutzer" -and -not $obj.Department -and $obj.Enabled) {
                $suspicious += " | Keine Abteilung zugewiesen"
            }
            
            if ([string]::IsNullOrWhiteSpace($obj.Description) -and $objectType -ne "Computer") {
                $suspicious += " | Keine Beschreibung"
            }
            
            $Timeline += [PSCustomObject]@{
                AccountName = $obj.SamAccountName
                DisplayName = if ($obj.DisplayName) { $obj.DisplayName } else { $obj.Name }
                CreatedDate = $createdDate.ToString("dd.MM.yyyy")
                CreatedTime = $createdDate.ToString("HH:mm:ss")
                CreatedBy = "N/A (Event-Log-Analyse erforderlich)"
                CreatedFrom = "N/A (Event-Log-Analyse erforderlich)"
                AccountType = $objectType
                Department = if ($obj.Department) { $obj.Department } else { "Nicht zugewiesen" }
                Enabled = if ($obj.PSObject.Properties['Enabled']) { $obj.Enabled } else { "N/A" }
                BulkCreation = $bulkCreation
                SameDayCount = $sameDay.Count
                Pattern = $pattern
                SuspiciousIndicator = if ([string]::IsNullOrWhiteSpace($suspicious) -or $suspicious -eq "Keine") { "Keine" } else { $suspicious.TrimStart(" | ") }
                DaysAgo = (New-TimeSpan -Start $createdDate -End (Get-Date)).Days
                Recommendation = if ($bulkCreation -and $sameDay.Count -gt 20) { "Massen-Erstellung prüfen" } elseif ($suspicious -ne "Keine") { "Attribute vervollständigen" } else { "OK" }
            }
        }
        
        if ($Timeline.Count -eq 0) {
            $Timeline += [PSCustomObject]@{
                AccountName = "Keine neuen Accounts"
                DisplayName = "N/A"
                CreatedDate = "N/A"
                CreatedTime = "N/A"
                CreatedBy = "N/A"
                ...
                BulkCreation = $false
                SameDayCount = 0
                Pattern = "Keine Accounts in den letzten 90 Tagen erstellt"
                SuspiciousIndicator = "Keine"
                DaysAgo = 0
                Recommendation = "Keine Maßnahmen erforderlich"
            }
        }
        
        Write-ADReportLog -Message "Account-Erstellungs-Timeline erstellt. $($Timeline.Count) Objekte analysiert." -Type Info
        return $Timeline | Sort-Object CreatedDate -Descending
        
    } catch {
        Write-ADReportLog -Message "Fehler bei der Account-Erstellungs-Timeline: $($_.Exception.Message)" -Type Error
        return @()
    }
}

Function Get-DeletedObjectsRecovery {
    [CmdletBinding()]
    param()
    
    try {
        Write-ADReportLog -Message "Suche gelöschte AD-Objekte..." -Type Info
        
        $DeletedObjects = @()
        
        try {
            $DomainDN = (Get-ADDomain).DistinguishedName
            $DeletedObjectsContainer = "CN=Deleted Objects,$DomainDN"
            
            $Deleted = Get-ADObject -Filter {isDeleted -eq $true} -IncludeDeletedObjects -Properties whenChanged, whenCreated, DisplayName, LastKnownParent, objectClass, isDeleted -ErrorAction Stop
            
            Write-ADReportLog -Message "Gefundene gelöschte Objekte: $($Deleted.Count)" -Type Info
            
            $TombstoneLifetime = (Get-ADObject -Identity "CN=Directory Service,CN=Windows NT,CN=Services,CN=Configuration,$DomainDN" -Properties tombstoneLifetime).tombstoneLifetime
            if (-not $TombstoneLifetime) { $TombstoneLifetime = 180 }
            
            foreach ($obj in $Deleted) {
                $deletedDate = $obj.whenChanged
                $daysDeleted = (New-TimeSpan -Start $deletedDate -End (Get-Date)).Days
                $daysRemaining = $TombstoneLifetime - $daysDeleted
                
                $recoveryPossible = $daysRemaining -gt 0
                $objectType = $obj.objectClass
                if ($objectType -is [array]) { $objectType = $objectType[-1] }
                
                $originalOU = if ($obj.LastKnownParent) { $obj.LastKnownParent } else { "Unbekannt" }
                
                $DeletedObjects += [PSCustomObject]@{
                    ObjectName = if ($obj.DisplayName) { $obj.DisplayName } else { $obj.Name }
                    ObjectType = $objectType
                    DeletedDate = $deletedDate.ToString("dd.MM.yyyy HH:mm:ss")
                    DeletedBy = "N/A (Event-Log erforderlich)"
                    OriginalOU = $originalOU
                    DaysDeleted = $daysDeleted
                    TombstoneLifetime = $TombstoneLifetime
                    DaysRemaining = if ($recoveryPossible) { $daysRemaining } else { 0 }
                    RecoveryPossible = if ($recoveryPossible) { "Ja" } else { "Nein - Tombstone abgelaufen" }
                    LastModified = if ($obj.whenCreated) { $obj.whenCreated.ToString("dd.MM.yyyy") } else { "Unbekannt" }
                    DistinguishedName = $obj.DistinguishedName
                    Recommendation = if ($recoveryPossible) { "Wiederherstellung mit Restore-ADObject möglich" } else { "Wiederherstellung nicht mehr möglich" }
                }
            }
        } catch {
            Write-ADReportLog -Message "FEHLER: Keine Berechtigung für Deleted Objects Container" -Type Error
            Write-ADReportLog -Message "Erforderlich: Domain Admins oder spezielle Delegation für Deleted Objects" -Type Warning
            Write-ADReportLog -Message "Technischer Fehler: $($_.Exception.Message)" -Type Warning
        }
        
        if ($DeletedObjects.Count -eq 0) {
            $DeletedObjects += [PSCustomObject]@{
                ObjectName = "Keine gelöschten Objekte"
                ObjectType = "N/A"
                DeletedDate = "N/A"
                DeletedBy = "N/A"
                OriginalOU = "N/A"
                ...
                TombstoneLifetime = 0
                DaysRemaining = 0
                RecoveryPossible = "N/A"
                LastModified = "N/A"
                DistinguishedName = "N/A"
                Recommendation = "Keine gelöschten Objekte gefunden oder keine Berechtigung"
            }
        }
        
        Write-ADReportLog -Message "Gelöschte Objekte Analyse abgeschlossen. $($DeletedObjects.Count) Objekte gefunden." -Type Info
        return $DeletedObjects | Sort-Object DaysRemaining -Descending
        
    } catch {
        Write-ADReportLog -Message "Fehler bei der Suche nach gelöschten Objekten: $($_.Exception.Message)" -Type Error
        return @()
    }
}

Function Get-ProxyAddressChanges {
    [CmdletBinding()]
    param()
    
    try {
        Write-ADReportLog -Message "Analysiere ProxyAddress-Änderungen..." -Type Info
        
        $ProxyChanges = @()
        $Properties = @('DisplayName', 'SamAccountName', 'proxyAddresses', 'mail', 'whenChanged', 'Department', 'Enabled')
        
        # PERFORMANCE-OPTIMIERUNG: Nur Benutzer mit proxyAddresses laden
        $AllUsers = Get-ADUser -Filter {proxyAddresses -like "*"} -Properties $Properties -ErrorAction SilentlyContinue
        
        # Auch Benutzer OHNE ProxyAddresses laden (für vollständige Analyse)
        # Filter muss mit Where-Object erfolgen, da komplexe Negation in -Filter nicht unterstützt wird
        $UsersWithoutProxy = Get-ADUser -Filter {Enabled -eq $true} -Properties DisplayName, SamAccountName, mail, Department, Enabled, proxyAddresses -ErrorAction SilentlyContinue | Where-Object { -not $_.proxyAddresses }
        
        Write-ADReportLog -Message "Analysiere ProxyAddresses für $($AllUsers.Count) Benutzer mit Proxy und $($UsersWithoutProxy.Count) ohne..." -Type Info
        
        # Benutzer MIT ProxyAddresses
        foreach ($user in $AllUsers) {
            if ($user.proxyAddresses) {
                $smtpAddresses = @($user.proxyAddresses | Where-Object { $_ -like "SMTP:*" -or $_ -like "smtp:*" })
                $primarySMTP = @($user.proxyAddresses | Where-Object { $_ -like "SMTP:*" })[0]
                $secondarySMTP = @($user.proxyAddresses | Where-Object { $_ -like "smtp:*" })
                
                $hasMultiplePrimary = ($user.proxyAddresses | Where-Object { $_ -like "SMTP:*" }).Count -gt 1
                $hasMismatch = $primarySMTP -and $user.mail -and ($primarySMTP -replace "SMTP:", "") -ne $user.mail
                ...
                if ($hasMultiplePrimary) {
                    $changeType = "Fehler"
                    $issues += "Mehrere primäre SMTP-Adressen"
                }
                
                if ($hasMismatch) {
                    $changeType = "Warnung"
                    $issues += "mail-Attribut stimmt nicht mit primärer SMTP überein"
                }
                
                if (-not $primarySMTP -and $smtpAddresses.Count -gt 0) {
                    $changeType = "Warnung"
                    $issues += "Keine primäre SMTP-Adresse definiert"
                }
                
                $ProxyChanges += [PSCustomObject]@{
                    UserName = $user.SamAccountName
                    DisplayName = $user.DisplayName
                    Department = if ($user.Department) { $user.Department } else { "Nicht angegeben" }
                    Enabled = $user.Enabled
                    ChangeDate = if ($user.whenChanged) { $user.whenChanged.ToString("dd.MM.yyyy HH:mm:ss") } else { "Unbekannt" }
                    ChangedBy = "N/A (Replication Metadata erforderlich)"
                    ChangeType = $changeType
                    PrimaryAddress = if ($primarySMTP) { $primarySMTP -replace "SMTP:", "" } else { "Keine" }
                    MailAttribute = if ($user.mail) { $user.mail } else { "Nicht gesetzt" }
                    SecondaryCount = $secondarySMTP.Count
                    TotalProxyCount = $user.proxyAddresses.Count
                    AllProxyAddresses = ($user.proxyAddresses | ForEach-Object { $_ -replace "SMTP:", "" -replace "smtp:", "" }) -join "; "
                    Domain = if ($primarySMTP) { ($primarySMTP -split "@")[1] -replace "SMTP:", "" } else { "N/A" }
                    Issues = if ($issues.Count -gt 0) { $issues -join " | " } else { "Keine" }
                    Recommendation = if ($hasMultiplePrimary) { "Dringend: Nur eine primäre SMTP-Adresse erlaubt" } elseif ($hasMismatch) { "mail-Attribut korrigieren" } elseif (-not $primarySMTP) { "Primäre SMTP-Adresse setzen" } else { "OK" }
                }
            }
        }
        
        # Benutzer OHNE ProxyAddresses hinzufügen (wichtig für Exchange-Umgebungen)
        foreach ($user in $UsersWithoutProxy) {
            $ProxyChanges += [PSCustomObject]@{
                ...
                ChangedBy = "N/A"
                ChangeType = "Warnung"
                PrimaryAddress = "Keine ProxyAddresses"
                MailAttribute = if ($user.mail) { $user.mail } else { "Nicht gesetzt" }
                SecondaryCount = 0
                TotalProxyCount = 0
                AllProxyAddresses = "Keine ProxyAddresses konfiguriert"
                Domain = "N/A"
                Issues = "Benutzer hat keine ProxyAddresses"
                Recommendation = "ProxyAddresses konfigurieren (wichtig für Exchange/Email)"
            }
        }
        
        if ($ProxyChanges.Count -eq 0) {
            $ProxyChanges += [PSCustomObject]@{
                UserName = "Keine Daten"
                DisplayName = "N/A"
                Department = "N/A"
                Enabled = "N/A"
                ChangeDate = "N/A"
                ChangedBy = "N/A"
                ChangeType = "Info"
                PrimaryAddress = "Keine Benutzer gefunden"
                MailAttribute = "N/A"
                SecondaryCount = 0
                TotalProxyCount = 0
                AllProxyAddresses = "N/A"
                Domain = "N/A"
                Issues = "Keine"
                Recommendation = "Keine Maßnahmen erforderlich"
            }
        ...
        Write-ADReportLog -Message "ProxyAddress-Analyse abgeschlossen. $($ProxyChanges.Count) Benutzer analysiert (mit und ohne ProxyAddresses)." -Type Info
        return $ProxyChanges | Sort-Object ChangeType, UserName
        
    } catch {
        Write-ADReportLog -Message "Fehler bei der ProxyAddress-Analyse: $($_.Exception.Message)" -Type Error
        return @()
    }
}
        ...
        try {
            ...
            foreach ($fgpp in $FGPPs) {
                $ConditionalPolicies.Add([PSCustomObject]@{
                    ...
                    Recommendation = "Ensure policy meets current security standards and best practices"
                })
            }
        } catch {
...
Function Initialize-ADReportForm {
    ...
    # Neue Feature Buttons
    $Global:ButtonQuickDSGVOCompliance = $Window.FindName("ButtonQuickDSGVOCompliance")
    $Global:ButtonQuickLoginTimeAnalysis = $Window.FindName("ButtonQuickLoginTimeAnalysis")
    $Global:ButtonQuickOrgChart = $Window.FindName("ButtonQuickOrgChart")
    $Global:ButtonQuickGPOConflictAnalysis = $Window.FindName("ButtonQuickGPOConflictAnalysis")
    $Global:ButtonQuickGPOSecurityBaseline = $Window.FindName("ButtonQuickGPOSecurityBaseline")
    $Global:ButtonQuickAccountCreationTimeline = $Window.FindName("ButtonQuickAccountCreationTimeline")
    $Global:ButtonQuickDeletedObjectsRecovery = $Window.FindName("ButtonQuickDeletedObjectsRecovery")
    $Global:ButtonQuickProxyAddressChanges = $Window.FindName("ButtonQuickProxyAddressChanges")
    
    # ============================================================================
    # NEUE FEATURES - BUTTON INITIALISIERUNG
    # ============================================================================
    
    # User Security - Neue Buttons
    $Global:ButtonQuickKerberosDelegation = $Window.FindName("ButtonQuickKerberosDelegation")
    $Global:ButtonQuickCertificateServices = $Window.FindName("ButtonQuickCertificateServices")
    $Global:ButtonQuickLAPSAnalysis = $Window.FindName("ButtonQuickLAPSAnalysis")
    $Global:ButtonQuickProtectedUsers = $Window.FindName("ButtonQuickProtectedUsers")
    $Global:ButtonQuickAuthPolicies = $Window.FindName("ButtonQuickAuthPolicies")
    $Global:ButtonQuickNTLMAudit = $Window.FindName("ButtonQuickNTLMAudit")
    $Global:ButtonQuickPreWin2000Access = $Window.FindName("ButtonQuickPreWin2000Access")
    $Global:ButtonQuickPAWAnalysis = $Window.FindName("ButtonQuickPAWAnalysis")
    $Global:ButtonQuickPasswordSpray = $Window.FindName("ButtonQuickPasswordSpray")
    $Global:ButtonQuickPasswordComplexity = $Window.FindName("ButtonQuickPasswordComplexity")
    $Global:ButtonQuickSmartCardRequired = $Window.FindName("ButtonQuickSmartCardRequired")
    $Global:ButtonQuickKerberosEncryption = $Window.FindName("ButtonQuickKerberosEncryption")
    
    # Security Threats - Neue Buttons
    $Global:ButtonQuickGoldenTicket = $Window.FindName("ButtonQuickGoldenTicket")
    $Global:ButtonQuickSilverTicket = $Window.FindName("ButtonQuickSilverTicket")
    $Global:ButtonQuickPassTheHash = $Window.FindName("ButtonQuickPassTheHash")
    $Global:ButtonQuickSkeletonKey = $Window.FindName("ButtonQuickSkeletonKey")
    
    # User Accounts - Neue Buttons
    $Global:ButtonQuickNestedGroupDepth = $Window.FindName("ButtonQuickNestedGroupDepth")
    $Global:ButtonQuickGroupMembershipTimeline = $Window.FindName("ButtonQuickGroupMembershipTimeline")
    $Global:ButtonQuickUPNConflicts = $Window.FindName("ButtonQuickUPNConflicts")
    $Global:ButtonQuickManagerChainValidation = $Window.FindName("ButtonQuickManagerChainValidation")
    $Global:ButtonQuickMultipleEmailAddresses = $Window.FindName("ButtonQuickMultipleEmailAddresses")
    
    # Computer Management - Neue Buttons
    $Global:ButtonQuickComputerTrustErrors = $Window.FindName("ButtonQuickComputerTrustErrors")
    $Global:ButtonQuickIPv6Readiness = $Window.FindName("ButtonQuickIPv6Readiness")
    
    # Policies and GPOs - Neue Buttons
    $Global:ButtonQuickGPOBackupStatus = $Window.FindName("ButtonQuickGPOBackupStatus")
    $Global:ButtonQuickGPOVersionDiscrepancy = $Window.FindName("ButtonQuickGPOVersionDiscrepancy")
    $Global:ButtonQuickWMIFilterAnalysis = $Window.FindName("ButtonQuickWMIFilterAnalysis")
    $Global:ButtonQuickGPOLoopback = $Window.FindName("ButtonQuickGPOLoopback")
    
    # Compliance and Audit - Neue Buttons
    $Global:ButtonQuickAuditPolicyCompliance = $Window.FindName("ButtonQuickAuditPolicyCompliance")
    $Global:ButtonQuickObjectAccessAuditing = $Window.FindName("ButtonQuickObjectAccessAuditing")
    $Global:ButtonQuickPrivilegedOperationTracking = $Window.FindName("ButtonQuickPrivilegedOperationTracking")
    $Global:ButtonQuickAccountLockoutTracking = $Window.FindName("ButtonQuickAccountLockoutTracking")
    $Global:ButtonQuickLoginTrends = $Window.FindName("ButtonQuickLoginTrends")
    $Global:ButtonQuickAccountCreationTrends = $Window.FindName("ButtonQuickAccountCreationTrends")
    $Global:ButtonQuickGroupMembershipChanges = $Window.FindName("ButtonQuickGroupMembershipChanges")
    $Global:ButtonQuickPasswordChangeFrequency = $Window.FindName("ButtonQuickPasswordChangeFrequency")
    $Global:ButtonQuickPCIDSSCompliance = $Window.FindName("ButtonQuickPCIDSSCompliance")
    
    # AD Infrastructure - Neue Buttons
    $Global:ButtonQuickStaleDNSRecords = $Window.FindName("ButtonQuickStaleDNSRecords")
    $Global:ButtonQuickDynamicDNSRegistration = $Window.FindName("ButtonQuickDynamicDNSRegistration")
    $Global:ButtonQuickSubnetAssignment = $Window.FindName("ButtonQuickSubnetAssignment")
    $Global:ButtonQuickReplicationLatency = $Window.FindName("ButtonQuickReplicationLatency")
    $Global:ButtonQuickSiteLinkCosts = $Window.FindName("ButtonQuickSiteLinkCosts")
    $Global:ButtonQuickExchangeAttributes = $Window.FindName("ButtonQuickExchangeAttributes")
    $Global:ButtonQuickAzureADConnect = $Window.FindName("ButtonQuickAzureADConnect")
    $Global:ButtonQuickCustomAttributes = $Window.FindName("ButtonQuickCustomAttributes")
    $Global:ButtonQuickAdminCountAnomalies = $Window.FindName("ButtonQuickAdminCountAnomalies")
    $Global:ButtonQuickComputerLifecycle = $Window.FindName("ButtonQuickComputerLifecycle")
    $Global:ButtonQuickNamingConventionViolations = $Window.FindName("ButtonQuickNamingConventionViolations")
    ...
    $ButtonQueryAD.add_Click({
        ...
        try {
            ...
            # Debug-Info ins Logfile schreiben
            Write-DebugLog "Selected attributes: $($SelectedAttributes -join '; ')" -Category "GUI"
...
"@
    ...
    # Event Handler für ButtonQuickDSGVOCompliance
    if ($null -ne $Global:ButtonQuickDSGVOCompliance) {
        $ButtonQuickDSGVOCompliance.add_Click({
            Write-ADReportLog -Message "Erstelle DSGVO/GDPR Compliance Report..." -Type Info
            try {
                $DSGVOReport = Get-DSGVOComplianceReport
                if ($DSGVOReport -and $DSGVOReport.Count -gt 0) {
                    Update-ADReportResults -Results $DSGVOReport
                    Write-ADReportLog -Message "DSGVO Compliance Report abgeschlossen. $($DSGVOReport.Count) Ergebnis(se) gefunden." -Type Info
                    Update-ResultCounters -Results $DSGVOReport
                    $Global:TextBlockStatus.Text = "DSGVO Compliance Report abgeschlossen."
                } else {
                    $Global:DataGridResults.ItemsSource = $null
                    Write-ADReportLog -Message "Keine DSGVO-Daten gefunden." -Type Info
                    $Global:TextBlockStatus.Text = "Keine DSGVO-Daten gefunden."
                }
            } catch {
                $ErrorMessage = "Fehler beim DSGVO Compliance Report: $($_.Exception.Message)"
                Write-ADReportLog -Message $ErrorMessage -Type Error
                Update-ADReportResults -Results @()
                $Global:TextBlockStatus.Text = "Fehler: $ErrorMessage"
            }
    ...
    # Event Handler für ButtonQuickLoginTimeAnalysis
    if ($null -ne $Global:ButtonQuickLoginTimeAnalysis) {
        $ButtonQuickLoginTimeAnalysis.add_Click({
            Write-ADReportLog -Message "Analysiere Login-Zeiten und Muster..." -Type Info
            try {
                $LoginTimeAnalysis = Get-LoginTimeAnalysis
                if ($LoginTimeAnalysis -and $LoginTimeAnalysis.Count -gt 0) {
                    Update-ADReportResults -Results $LoginTimeAnalysis
                    Write-ADReportLog -Message "Login-Zeit Analyse abgeschlossen. $($LoginTimeAnalysis.Count) Ergebnis(se) gefunden." -Type Info
                    Update-ResultCounters -Results $LoginTimeAnalysis
                    $Global:TextBlockStatus.Text = "Login-Zeit Analyse abgeschlossen."
                } else {
                    $Global:DataGridResults.ItemsSource = $null
                    Write-ADReportLog -Message "Keine ungewöhnlichen Login-Zeiten gefunden." -Type Info
                    $Global:TextBlockStatus.Text = "Keine ungewöhnlichen Login-Zeiten gefunden."
                }
            } catch {
                $ErrorMessage = "Fehler bei der Login-Zeit Analyse: $($_.Exception.Message)"
                Write-ADReportLog -Message $ErrorMessage -Type Error
                Update-ADReportResults -Results @()
                $Global:TextBlockStatus.Text = "Fehler: $ErrorMessage"
            }
    ...
    # Event Handler für ButtonQuickOrgChart
    if ($null -ne $Global:ButtonQuickOrgChart) {
        $ButtonQuickOrgChart.add_Click({
            Write-ADReportLog -Message "Erstelle Organigramm-Export..." -Type Info
            try {
                $OrgChart = Get-OrganizationChart
                if ($OrgChart -and $OrgChart.Count -gt 0) {
                    Update-ADReportResults -Results $OrgChart
                    Write-ADReportLog -Message "Organigramm-Export abgeschlossen. $($OrgChart.Count) Ergebnis(se) gefunden." -Type Info
                    Update-ResultCounters -Results $OrgChart
                    $Global:TextBlockStatus.Text = "Organigramm-Export abgeschlossen."
                } else {
                    $Global:DataGridResults.ItemsSource = $null
                    Write-ADReportLog -Message "Keine Organisationsdaten gefunden." -Type Info
                    $Global:TextBlockStatus.Text = "Keine Organisationsdaten gefunden."
                }
            } catch {
                $ErrorMessage = "Fehler beim Organigramm-Export: $($_.Exception.Message)"
                Write-ADReportLog -Message $ErrorMessage -Type Error
                Update-ADReportResults -Results @()
                $Global:TextBlockStatus.Text = "Fehler: $ErrorMessage"
            }
    ...
    # Event Handler für ButtonQuickGPOConflictAnalysis
    if ($null -ne $Global:ButtonQuickGPOConflictAnalysis) {
        $ButtonQuickGPOConflictAnalysis.add_Click({
            Write-ADReportLog -Message "Analysiere GPO-Konflikte..." -Type Info
            try {
                $GPOConflicts = Get-GPOConflictAnalysis
                if ($GPOConflicts -and $GPOConflicts.Count -gt 0) {
                    Update-ADReportResults -Results $GPOConflicts
                    Write-ADReportLog -Message "GPO-Konflikt Analyse abgeschlossen. $($GPOConflicts.Count) Ergebnis(se) gefunden." -Type Info
                    Update-ResultCounters -Results $GPOConflicts
                    $Global:TextBlockStatus.Text = "GPO-Konflikt Analyse abgeschlossen."
                } else {
                    $Global:DataGridResults.ItemsSource = $null
                    Write-ADReportLog -Message "Keine GPO-Konflikte gefunden." -Type Info
                    $Global:TextBlockStatus.Text = "Keine GPO-Konflikte gefunden."
                }
            } catch {
                $ErrorMessage = "Fehler bei der GPO-Konflikt Analyse: $($_.Exception.Message)"
                Write-ADReportLog -Message $ErrorMessage -Type Error
                Update-ADReportResults -Results @()
                $Global:TextBlockStatus.Text = "Fehler: $ErrorMessage"
            }
    ...
    # Event Handler für ButtonQuickGPOSecurityBaseline
    if ($null -ne $Global:ButtonQuickGPOSecurityBaseline) {
        $ButtonQuickGPOSecurityBaseline.add_Click({
            Write-ADReportLog -Message "Vergleiche GPOs mit Security Baseline..." -Type Info
            try {
                $GPOBaseline = Get-GPOSecurityBaseline
                if ($GPOBaseline -and $GPOBaseline.Count -gt 0) {
                    Update-ADReportResults -Results $GPOBaseline
                    Write-ADReportLog -Message "GPO Security Baseline Vergleich abgeschlossen. $($GPOBaseline.Count) Ergebnis(se) gefunden." -Type Info
                    Update-ResultCounters -Results $GPOBaseline
                    $Global:TextBlockStatus.Text = "GPO Security Baseline Vergleich abgeschlossen."
                } else {
                    $Global:DataGridResults.ItemsSource = $null
                    Write-ADReportLog -Message "Keine Baseline-Abweichungen gefunden." -Type Info
                    $Global:TextBlockStatus.Text = "Keine Baseline-Abweichungen gefunden."
                }
            } catch {
                $ErrorMessage = "Fehler beim GPO Security Baseline Vergleich: $($_.Exception.Message)"
                Write-ADReportLog -Message $ErrorMessage -Type Error
                Update-ADReportResults -Results @()
                $Global:TextBlockStatus.Text = "Fehler: $ErrorMessage"
            }
    ...
    # Event Handler für ButtonQuickAccountCreationTimeline
    if ($null -ne $Global:ButtonQuickAccountCreationTimeline) {
        $ButtonQuickAccountCreationTimeline.add_Click({
            Write-ADReportLog -Message "Erstelle Account-Erstellungs-Timeline..." -Type Info
            try {
                $AccountTimeline = Get-AccountCreationTimeline
                if ($AccountTimeline -and $AccountTimeline.Count -gt 0) {
                    Update-ADReportResults -Results $AccountTimeline
                    Write-ADReportLog -Message "Account-Erstellungs-Timeline abgeschlossen. $($AccountTimeline.Count) Ergebnis(se) gefunden." -Type Info
                    Update-ResultCounters -Results $AccountTimeline
                    $Global:TextBlockStatus.Text = "Account-Erstellungs-Timeline abgeschlossen."
                } else {
                    $Global:DataGridResults.ItemsSource = $null
                    Write-ADReportLog -Message "Keine Account-Erstellungsdaten gefunden." -Type Info
                    $Global:TextBlockStatus.Text = "Keine Account-Erstellungsdaten gefunden."
                }
            } catch {
                $ErrorMessage = "Fehler bei der Account-Erstellungs-Timeline: $($_.Exception.Message)"
                Write-ADReportLog -Message $ErrorMessage -Type Error
                Update-ADReportResults -Results @()
                $Global:TextBlockStatus.Text = "Fehler: $ErrorMessage"
            }
    ...
    # Event Handler für ButtonQuickDeletedObjectsRecovery
    if ($null -ne $Global:ButtonQuickDeletedObjectsRecovery) {
        $ButtonQuickDeletedObjectsRecovery.add_Click({
            Write-ADReportLog -Message "Suche gelöschte AD-Objekte..." -Type Info
            try {
                $DeletedObjects = Get-DeletedObjectsRecovery
                if ($DeletedObjects -and $DeletedObjects.Count -gt 0) {
                    Update-ADReportResults -Results $DeletedObjects
                    Write-ADReportLog -Message "Gelöschte Objekte gefunden. $($DeletedObjects.Count) Ergebnis(se) gefunden." -Type Info
                    Update-ResultCounters -Results $DeletedObjects
                    $Global:TextBlockStatus.Text = "Gelöschte Objekte gefunden."
                } else {
                    $Global:DataGridResults.ItemsSource = $null
                    Write-ADReportLog -Message "Keine gelöschten Objekte gefunden." -Type Info
                    $Global:TextBlockStatus.Text = "Keine gelöschten Objekte gefunden."
                }
            } catch {
                $ErrorMessage = "Fehler bei der Suche nach gelöschten Objekten: $($_.Exception.Message)"
                Write-ADReportLog -Message $ErrorMessage -Type Error
                Update-ADReportResults -Results @()
                $Global:TextBlockStatus.Text = "Fehler: $ErrorMessage"
            }
    ...
    # Event Handler für ButtonQuickProxyAddressChanges
    if ($null -ne $Global:ButtonQuickProxyAddressChanges) {
        $ButtonQuickProxyAddressChanges.add_Click({
            Write-ADReportLog -Message "Analysiere ProxyAddress-Änderungen..." -Type Info
            try {
                $ProxyChanges = Get-ProxyAddressChanges
                if ($ProxyChanges -and $ProxyChanges.Count -gt 0) {
                    Update-ADReportResults -Results $ProxyChanges
                    Write-ADReportLog -Message "ProxyAddress-Änderungen analysiert. $($ProxyChanges.Count) Ergebnis(se) gefunden." -Type Info
                    Update-ResultCounters -Results $ProxyChanges
                    $Global:TextBlockStatus.Text = "ProxyAddress-Änderungen analysiert."
                } else {
                    $Global:DataGridResults.ItemsSource = $null
                    Write-ADReportLog -Message "Keine ProxyAddress-Änderungen gefunden." -Type Info
                    $Global:TextBlockStatus.Text = "Keine ProxyAddress-Änderungen gefunden."
                }
            } catch {
                $ErrorMessage = "Fehler bei der ProxyAddress-Analyse: $($_.Exception.Message)"
                Write-ADReportLog -Message $ErrorMessage -Type Error
                Update-ADReportResults -Results @()
                $Global:TextBlockStatus.Text = "Fehler: $ErrorMessage"
            }
    ...
    # ============================================================================
    # NEUE FEATURES - EVENT HANDLER
    # ============================================================================
    
    # User Security - Event Handler
    if ($null -ne $Global:ButtonQuickKerberosDelegation) {
        $ButtonQuickKerberosDelegation.add_Click({
            Show-QuickReport -Title "Kerberos Delegation Analysis" -DataFunction { 
                Write-Host "Platzhalter: Kerberos Delegation Analyse wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickCertificateServices) {
        $ButtonQuickCertificateServices.add_Click({
            Show-QuickReport -Title "Certificate Services Analysis" -DataFunction { 
                Write-Host "Platzhalter: Certificate Services Analyse wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickLAPSAnalysis) {
        $ButtonQuickLAPSAnalysis.add_Click({
            Show-QuickReport -Title "LAPS Analysis" -DataFunction { 
                Write-Host "Platzhalter: LAPS Analyse wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickProtectedUsers) {
        $ButtonQuickProtectedUsers.add_Click({
            Show-QuickReport -Title "Protected Users Group Analysis" -DataFunction { 
                Write-Host "Platzhalter: Protected Users Analyse wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickAuthPolicies) {
        $ButtonQuickAuthPolicies.add_Click({
            Show-QuickReport -Title "Authentication Policies" -DataFunction { 
                Write-Host "Platzhalter: Authentication Policies Analyse wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickNTLMAudit) {
        $ButtonQuickNTLMAudit.add_Click({
            Show-QuickReport -Title "NTLM Audit" -DataFunction { 
                Write-Host "Platzhalter: NTLM Audit wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickPreWin2000Access) {
        $ButtonQuickPreWin2000Access.add_Click({
            Show-QuickReport -Title "Pre-Windows 2000 Compatible Access" -DataFunction { 
                Write-Host "Platzhalter: Pre-Win2000 Access Analyse wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickPAWAnalysis) {
        $ButtonQuickPAWAnalysis.add_Click({
            Show-QuickReport -Title "PAW Analysis" -DataFunction { 
                Write-Host "Platzhalter: PAW Analyse wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickPasswordSpray) {
        $ButtonQuickPasswordSpray.add_Click({
            Show-QuickReport -Title "Password Spray Detection" -DataFunction { 
                Write-Host "Platzhalter: Password Spray Detection wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickPasswordComplexity) {
        $ButtonQuickPasswordComplexity.add_Click({
            Show-QuickReport -Title "Password Complexity Compliance" -DataFunction { 
                Write-Host "Platzhalter: Password Complexity Analyse wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickSmartCardRequired) {
        $ButtonQuickSmartCardRequired.add_Click({
            Show-QuickReport -Title "Smart Card Required Accounts" -DataFunction { 
                Write-Host "Platzhalter: Smart Card Required Analyse wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickKerberosEncryption) {
        $ButtonQuickKerberosEncryption.add_Click({
            Show-QuickReport -Title "Kerberos Encryption Types" -DataFunction { 
                Write-Host "Platzhalter: Kerberos Encryption Types Analyse wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    # Security Threats - Event Handler
    if ($null -ne $Global:ButtonQuickGoldenTicket) {
        $ButtonQuickGoldenTicket.add_Click({
            Show-QuickReport -Title "Golden Ticket Indicators" -DataFunction { 
                Write-Host "Platzhalter: Golden Ticket Detection wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickSilverTicket) {
        $ButtonQuickSilverTicket.add_Click({
            Show-QuickReport -Title "Silver Ticket Indicators" -DataFunction { 
                Write-Host "Platzhalter: Silver Ticket Detection wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickPassTheHash) {
        $ButtonQuickPassTheHash.add_Click({
            Show-QuickReport -Title "Pass-the-Hash Indicators" -DataFunction { 
                Write-Host "Platzhalter: Pass-the-Hash Detection wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickSkeletonKey) {
        $ButtonQuickSkeletonKey.add_Click({
            Show-QuickReport -Title "Skeleton Key Detection" -DataFunction { 
                Write-Host "Platzhalter: Skeleton Key Detection wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    # User Accounts - Event Handler
    if ($null -ne $Global:ButtonQuickNestedGroupDepth) {
        $ButtonQuickNestedGroupDepth.add_Click({
            Show-QuickReport -Title "Nested Group Depth Analysis" -DataFunction { 
                Write-Host "Platzhalter: Nested Group Depth Analyse wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickGroupMembershipTimeline) {
        $ButtonQuickGroupMembershipTimeline.add_Click({
            Show-QuickReport -Title "Group Membership Timeline" -DataFunction { 
                Write-Host "Platzhalter: Group Membership Timeline wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickUPNConflicts) {
        $ButtonQuickUPNConflicts.add_Click({
            Show-QuickReport -Title "UPN Conflicts" -DataFunction { 
                Write-Host "Platzhalter: UPN Conflicts Analyse wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickManagerChainValidation) {
        $ButtonQuickManagerChainValidation.add_Click({
            Show-QuickReport -Title "Manager Chain Validation" -DataFunction { 
                Write-Host "Platzhalter: Manager Chain Validation wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickMultipleEmailAddresses) {
        $ButtonQuickMultipleEmailAddresses.add_Click({
            Show-QuickReport -Title "Users with Multiple Email Addresses" -DataFunction { 
                Write-Host "Platzhalter: Multiple Email Addresses Analyse wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    # Computer Management - Event Handler
    if ($null -ne $Global:ButtonQuickComputerTrustErrors) {
        $ButtonQuickComputerTrustErrors.add_Click({
            Show-QuickReport -Title "Computer Trust Relationship Errors" -DataFunction { 
                Write-Host "Platzhalter: Computer Trust Errors Analyse wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickIPv6Readiness) {
        $ButtonQuickIPv6Readiness.add_Click({
            Show-QuickReport -Title "IPv6 Readiness Analysis" -DataFunction { 
                Write-Host "Platzhalter: IPv6 Readiness Analyse wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    # Policies and GPOs - Event Handler
    if ($null -ne $Global:ButtonQuickGPOBackupStatus) {
        $ButtonQuickGPOBackupStatus.add_Click({
            Show-QuickReport -Title "GPO Backup Status" -DataFunction { 
                Write-Host "Platzhalter: GPO Backup Status wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickGPOVersionDiscrepancy) {
        $ButtonQuickGPOVersionDiscrepancy.add_Click({
            Show-QuickReport -Title "GPO Version Discrepancy" -DataFunction { 
                Write-Host "Platzhalter: GPO Version Discrepancy wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickWMIFilterAnalysis) {
        $ButtonQuickWMIFilterAnalysis.add_Click({
            Show-QuickReport -Title "WMI Filter Analysis" -DataFunction { 
                Write-Host "Platzhalter: WMI Filter Analyse wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickGPOLoopback) {
        $ButtonQuickGPOLoopback.add_Click({
            Show-QuickReport -Title "GPO Loopback Processing" -DataFunction { 
                Write-Host "Platzhalter: GPO Loopback Processing wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    # Compliance and Audit - Event Handler
    if ($null -ne $Global:ButtonQuickAuditPolicyCompliance) {
        $ButtonQuickAuditPolicyCompliance.add_Click({
            Show-QuickReport -Title "Audit Policy Compliance" -DataFunction { 
                Write-Host "Platzhalter: Audit Policy Compliance wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickObjectAccessAuditing) {
        $ButtonQuickObjectAccessAuditing.add_Click({
            Show-QuickReport -Title "Object Access Auditing" -DataFunction { 
                Write-Host "Platzhalter: Object Access Auditing wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickPrivilegedOperationTracking) {
        $ButtonQuickPrivilegedOperationTracking.add_Click({
            Show-QuickReport -Title "Privileged Operation Tracking" -DataFunction { 
                Write-Host "Platzhalter: Privileged Operation Tracking wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickAccountLockoutTracking) {
        $ButtonQuickAccountLockoutTracking.add_Click({
            Show-QuickReport -Title "Account Lockout Source Tracking" -DataFunction { 
                Write-Host "Platzhalter: Account Lockout Tracking wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickLoginTrends) {
        $ButtonQuickLoginTrends.add_Click({
            Show-QuickReport -Title "Login Trends Over Time" -DataFunction { 
                Write-Host "Platzhalter: Login Trends wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickAccountCreationTrends) {
        $ButtonQuickAccountCreationTrends.add_Click({
            Show-QuickReport -Title "Account Creation Trends" -DataFunction { 
                Write-Host "Platzhalter: Account Creation Trends wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickGroupMembershipChanges) {
        $ButtonQuickGroupMembershipChanges.add_Click({
            Show-QuickReport -Title "Group Membership Changes" -DataFunction { 
                Write-Host "Platzhalter: Group Membership Changes wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickPasswordChangeFrequency) {
        $ButtonQuickPasswordChangeFrequency.add_Click({
            Show-QuickReport -Title "Password Change Frequency" -DataFunction { 
                Write-Host "Platzhalter: Password Change Frequency wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickPCIDSSCompliance) {
        $ButtonQuickPCIDSSCompliance.add_Click({
            Show-QuickReport -Title "PCI-DSS Compliance" -DataFunction { 
                Write-Host "Platzhalter: PCI-DSS Compliance wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    # AD Infrastructure - Event Handler
    if ($null -ne $Global:ButtonQuickStaleDNSRecords) {
        $ButtonQuickStaleDNSRecords.add_Click({
            Show-QuickReport -Title "Stale DNS Records" -DataFunction { 
                Write-Host "Platzhalter: Stale DNS Records wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickDynamicDNSRegistration) {
        $ButtonQuickDynamicDNSRegistration.add_Click({
            Show-QuickReport -Title "Dynamic DNS Registration" -DataFunction { 
                Write-Host "Platzhalter: Dynamic DNS Registration wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickSubnetAssignment) {
        $ButtonQuickSubnetAssignment.add_Click({
            Show-QuickReport -Title "Subnet Assignment Analysis" -DataFunction { 
                Write-Host "Platzhalter: Subnet Assignment wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickReplicationLatency) {
        $ButtonQuickReplicationLatency.add_Click({
            Show-QuickReport -Title "Replication Latency" -DataFunction { 
                Write-Host "Platzhalter: Replication Latency wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickSiteLinkCosts) {
        $ButtonQuickSiteLinkCosts.add_Click({
            Show-QuickReport -Title "Site Link Costs Analysis" -DataFunction { 
                Write-Host "Platzhalter: Site Link Costs wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickExchangeAttributes) {
        $ButtonQuickExchangeAttributes.add_Click({
            Show-QuickReport -Title "Exchange Attribute Analysis" -DataFunction { 
                Write-Host "Platzhalter: Exchange Attributes wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickAzureADConnect) {
        $ButtonQuickAzureADConnect.add_Click({
            Show-QuickReport -Title "Azure AD Connect Status" -DataFunction { 
                Write-Host "Platzhalter: Azure AD Connect wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickCustomAttributes) {
        $ButtonQuickCustomAttributes.add_Click({
            Show-QuickReport -Title "Custom Attribute Usage" -DataFunction { 
                Write-Host "Platzhalter: Custom Attributes wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickAdminCountAnomalies) {
        $ButtonQuickAdminCountAnomalies.add_Click({
            Show-QuickReport -Title "AdminCount Anomalies" -DataFunction { 
                Write-Host "Platzhalter: AdminCount Anomalies wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickComputerLifecycle) {
        $ButtonQuickComputerLifecycle.add_Click({
            Show-QuickReport -Title "Computer Lifecycle Analysis" -DataFunction { 
                Write-Host "Platzhalter: Computer Lifecycle wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
    
    if ($null -ne $Global:ButtonQuickNamingConventionViolations) {
        $ButtonQuickNamingConventionViolations.add_Click({
            Show-QuickReport -Title "Naming Convention Violations" -DataFunction { 
                Write-Host "Platzhalter: Naming Convention Violations wird implementiert"
                @([PSCustomObject]@{Info="Feature wird vom Benutzer implementiert"})
            }
        })
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCk92rJunwD5X/W
# LGaW63YTZdHMtWiERJ69TbxCNsBnGKCCILswggXJMIIEsaADAgECAhAbtY8lKt8j
...
# BCDaNBgav/E8DPdhWCKajKuDqq0wb/hNQkNA0zFeAwIYPzANBgkqhkiG9w0BAQEF
# AASCAgAH2An5gVVqYCJ28cZicvtngNv9v/4UvVjPdsBAU0NX1PN+/pQbEUblTXug
# l9wtZHjv362cfvZpQc6Pxj+jPciHNDYHN9BFZARnqqX2MeYjsNfO26AOyQ0k/+QN
# FKPds2vU4vpoYaX0pETjjB2NppUrpLdvKZaY/u0gG7U908/YC2p4uN9IyEtibxxZ
# lJ5leTnRjc+s1KS2GC8wrm1Koe1tQQQtTmTSznsvKuMsBDKKwURjrgnm/5lTpUFM
# IElNZWjTyRAiYb0pPiJLz2+RtslS1zjuOz6m3aMK6KdcJmlEG2PVxUk3t0aBVBa3
# Gsq22dIJpapASxMXscovr9YpmlbJYFAQWePJ7YhRPrmUyQPHvue/wXdqmTpOyKcp
# oE+CT7R0ThzJ02XZaM+YjaygDE82Ie0JbWTjbM9W5rudsS2vvDxpXRwboTPJioni
# +/hefk/9+L/GEaaP080zO0q3wxdi+umICArQsqkszp6jqhZhkqGZU9Op04Yf2N5Q
# IxH9iigK+Zq8MWvHFjDUwMa7L5RS1Z0/RvjbTXuCPgZlsmNDWvdAE0Wj32VyX205
# J9ciprtNeG7+ei2gDc6wTRW0KDnLibgy7cpoiwSY1sQH9weQEFJfM95IperVfM5g
# ztNbAo5XoJ1PFFZbr+fgH4gYhYGeKkuMx/+Hs7BjU2vY94QkS6GCBAQwggQABgkq
...
# MjUxMDI3MDcyNzIwWjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDPodw1ne0rw8uJ
# D6Iw5dr3e1QPGm4rI93PF1ThjPqg1TA/BgkqhkiG9w0BCQQxMgQw4oh9KF8UH0DN
# kOijEB8Zl9lI/ALW6SrN4KTaYoxcGpcNdP2OjelGd60g+a95xmecMIGgBgsqhkiG
...
# tKcCbUmMbHiNqjANBgkqhkiG9w0BAQEFAASCAgAe/t+FmfCEG1YmACqxYDifZ339
# y4U+MMYQf0YRciHLFut9jf9Os8bFeCuKvfrC+yA3XeYsZ3Cc3H9H9qlmWUWIqdKb
# 925kHV7KQH3rx1u2SC7Ria8u2Xs1mMx4QieGfvxw9E5SQSgbssWaJ99Uv9taIw+X
# Uj89vdM1JyBfi3M+1L3YeSpACqTvN7Pcedr2h/OeVVTsfWarnFF2+0WDqYqGLy81
# BOy22OowOGO7nmzDdSZxuSZMwy3ON/wW9wMeL46eeGOBFMCSMBr3MwK3VUxlKmQC
# 7Pr+Piwwn6AX9ODB+9Zg7Gj3n+lrTD85yXjJcR32YY3rryi6VwC1tN1JVZ0GjuT3
# v/PfR4mWeO7vd5IYfHKaREKoOEa25Os97jnAh8HXCSiaf22qxRk7vv45JC2w/8oH
# 1obKdpbwUlVDVQDu0PSw8dZxy/HEJ6wUvNeZDNPyQI9e+zyo6nUQ241vRM3A8/Sv
# dCvO7/FUMRFKH85d3QXJRH4QXrQWQc90nbv6LOk8LA6xQ+6dgeTkjSaOcfO8PUCv
# 4I2ZzfJ/jMpcqemN2meeDveJABsPSBEqb9fG+ZQ4KUMknLJ3oi6g2Rubq3dJJjJC
# sNXXBKZS9eQ8e2XOFdenETytLCVtLUAfKYrR7lBNqc5EqBUnsTUZecsjNgHfSdJw
# LiyycZ+/SU5bhHphGQ==
